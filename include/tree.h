...
//   int decision_attr_index: Attribute index for split (valid if INTERNAL)
...
tree_node* tree_create_internal(int decision_attr_index, const int* sample_indices, int sample_count);
